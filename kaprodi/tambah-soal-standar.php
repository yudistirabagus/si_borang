                            ...
                            <div class="panel-body p-left">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group p-left">
                                        <label for="namaStandar">Tambah Soal Standar</label>
                                        <textarea class="wysihtml5 form-control" type="text" name="soal_standar" required cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="form-group p-left">
                                ...
                                <?php
                                    if(isset($_POST['tambah'])){
                                        ...
                                        $querytambah = mysqli_query($koneksi, "INSERT INTO soal VALUES(NULL, '$id_isi_standar','$soal_standar','')");
                                            if($querytambah){
