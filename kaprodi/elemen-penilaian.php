        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <?php
                ...
                $query = mysqli_query($koneksi,
                    "SELECT * FROM standar INNER JOIN isi_standar
                            ...
                            <div class="panel-body p-left">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group p-left">
                                        <label for="namaStandar">Tambah Deskripsi Standar</label>
                                        <textarea class="wysihtml5 form-control" type="text" name="nama_deskriptor" required cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="form-group p-left">
                                        <label for="namaBobot">Sangat Baik</label>
                                        <textarea class="wysihtml5 form-control" type="text" name="sangat_baik" required cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="form-group p-left">
                                        <label for="namaBobot">Baik</label>
                                        <textarea class="wysihtml5 form-control" type="text" name="baik" required cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="form-group p-left">
                                        <label for="namaBobot">Cukup</label>
                                        <textarea class="wysihtml5 form-control" type="text" name="cukup" required cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="form-group p-left">
                                        <label for="namaBobot">Kurang</label>
                                        <textarea class="wysihtml5 form-control" type="text" name="kurang" required cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="form-group p-left">
                                        <label for="namaBobot">Sangat Kurang</label>
                                        <textarea class="wysihtml5 form-control" type="text" name="sangat_kurang" required cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="form-group p-left">
                                        <label for="namaBobot">Bobot</label>
                                        <input type="text" name="bobot" class="form-control" data-mask="9.99" required>
                                    </div>
                                    <div class="form-group p-left">
                                ...
                                <?php
                                    if(isset($_POST['tambah'])){
                                        ...
                                        $bobot = $_POST['bobot'];
                                        $querytambah = mysqli_query($koneksi, "INSERT INTO deskriptor VALUES(NULL, '$id_isi_standar','$nama_deskriptor','$sangat_baik','$baik','$cukup','$kurang','$sangat_kurang','$bobot')");
                                            if($querytambah){
                                                header("location:./lihat-deskriptor-isi-standar.php?id_standar=$id_standar");
                                        }else{
