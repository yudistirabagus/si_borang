                            ...
                            <table class="table responsive-data-table data-table">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $query = mysqli_query($koneksi, "SELECT * FROM standar") or die (mysqli_error());
                                            if(mysqli_num_rows($query) == 0){
                                                echo "<tr><td colspan='2' align='center'>Tidak ada data yang tersedia!!</td></tr>";
                                            }else{
                                                while($r = mysqli_fetch_array($query)):
                                    ?>                                
                                    <tr>
                                        <td align="center"><?php echo $r['id_standar'] ?></td>
                                        <td><a href="./hasil-soal-standar.php?id_standar=<?php echo $r['id_standar'] ?>"><?php echo $r['nama_standar'] ?></a></td>
                                    </tr>
                                    <?php
                                        endwhile;
                                            }
