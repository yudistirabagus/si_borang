        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="wrapper">
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading"><?php echo $r['nama_standar'] ?></header>
                            <div class="panel-body p-left">
                                <form action="" method="POST">
                                    <input type="hidden" name="id_standar" value="<?php echo $r['id_standar'] ?>">
                                    <div class="form-group">
                                        <label for="namaStandar">Isi Standar</label>
                                        <textarea class="form-control" type="text" name="isi_standar" required cols="30" rows="7"><?php echo $r['isi_standar'] ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <button class="btn btn-success" type="submit" name="edit"><i class="fa fa-save"></i> Simpan</button>
                                        <a href="./soal-standar.php?id_standar=<?php echo "$id_standar" ?>" class="btn btn-default" type="button"><i class="fa fa-refresh"></i> Batal</a>
                                    </div>
                                </form>
                                <?php
                                    if(isset($_POST['edit'])){
                                        $id_standar = $_POST['id_standar'];
                                        $isi_standar = $_POST['isi_standar'];
                                        $queryupdate = mysqli_query($koneksi, "UPDATE isi_standar SET isi_standar='$isi_standar' WHERE id_isi_standar=$id_isi_standar");
                                            if($queryupdate){
...
<script type="text/javascript">
    ...
    toolbar: "insertfile undo redo | table | bold italic | alignleft aligncenter alignright alignjustify | styleselect | bullist numlist outdent indent | link image | code",
        image_advtab: true,
