                        ...
                        <section class="panel">                                                      
                            <div class="panel-body">
                                <div class="form-group">
                                    <section class="panel">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                    $query2 = mysqli_query($koneksi, "SELECT * FROM hasil_nilai_standar WHERE id_standar='$id_standar' ORDER BY no_butir_penilaian ASC") or die (mysqli_error());
                                ...
                                <div class="form-group btn-lf" align="center">
                                    <a href="./hasil-soal-standar.php?id_standar=<?php echo $id_standar ?>" class="btn btn-danger m-b-10"><i class="fa fa-arrow-left"></i> Kembali</a>
                                </div>
                            </div>
                        </section>
                    </div>
