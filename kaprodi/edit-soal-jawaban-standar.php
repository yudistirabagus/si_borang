                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <div class="panel-body p-left">
                                ...
                                <div class="p-left"><?php echo $res['soal_standar']; ?></div>
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group p-left p-left-tt">
                                        <label for="namaStandar">Edit Jawaban</label>
                                ...
                                <?php
                                    ...
                                    $queryupdate = mysqli_query($koneksi, "UPDATE soal SET id_isi_standar='$id_isi_standar',jawaban='$jawaban' WHERE id_soal=$id_soal");
                                        if($queryupdate){
