                            ...
                            <div class="panel-body p-left">
                                <form action="" method="POST">
                                    <div class="form-group">
                                        <label for="namaStandar">Tambah Isi Standar</label>
                                        <textarea class="wysihtml5 form-control" type="text" name="isi_standar" required cols="30" rows="10"></textarea>
                                    </div>
                                    <div class="form-group">                 
                                ...
                                <?php
                                    if(isset($_POST['tambah'])){
                                        ...
                                        $querytambah = mysqli_query($koneksi, "INSERT INTO isi_standar VALUES(NULL, '$id_standar','$isi_standar')");
                                        if($querytambah){
