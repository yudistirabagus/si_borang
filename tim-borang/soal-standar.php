                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group p-left">
                                    <div class="col-sm-12 tit-standar">
                                        ...
                                        <?php
                                            $query2 = mysqli_query($koneksi, "SELECT * FROM soal WHERE id_isi_standar='$sub_id'") or die (mysqli_error());
                                                if(mysqli_num_rows($query2) == 0){
                                                    echo "<div class='sub-p err-text'>Belum ada soal!!</div>";
                                                }else{
                                                    while($rw=mysqli_fetch_array($query2)):
                                        ?>
                                        <div class="p-left-tt">
                                            <div class="tt"><?php echo $rw['soal_standar']; ?></div>
                                            <div class="btn-isi">
                                                <a href="./jawab-soal.php?id_standar=<?php echo $res['id_standar']; ?>&id_isi_standar=<?php echo $r['id_isi_standar']; ?>&id_soal=<?php echo $rw['id_soal']; ?>" class="btn btn-success m-b-10 btn-xs"><i class="fa fa-file-text-o"></i> Jawab Soal</a>
                                            </div>                                            
                                        </div>
                                        <?php
                                            endwhile;
                            ...
                            <div class="form-group p-left-tt" align="center">
                                ...
                                <a href="./masukan-elemen-penilaian.php?id_standar=<?php echo $res['id_standar']; ?>" class="btn btn-info m-b-10"><i class="fa fa-file-text-o"></i> Masukan Elemen Penilaian</a>
                            </div>
                        </section>
                    </div>
                </div>
