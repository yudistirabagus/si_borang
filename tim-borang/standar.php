                        ...
                        <ul class="notification-menu">
                            <li>
                                <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                    <img src="../asset/img/avatar-mini.jpg" alt="">
                            ...
                            <table class="table responsive-data-table data-table">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $query = mysqli_query($koneksi, "SELECT * FROM standar INNER JOIN user WHERE standar.id_user=user.id_user AND user.username='$username'") or die (mysqli_error());
                                            if(mysqli_num_rows($query) == 0){
                                                echo "<tr><td colspan='2' align='center'>Belum ada data standar!!</td></tr>";
                                            }else{
