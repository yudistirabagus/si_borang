                            ...
                            <div class="panel-body">
                                ...
                                <form action="" method="POST">
                                    <div class="form-group p-left">
                                        ...
                                        <input class="form-control" type="text" name="username" value="<?php echo $res['username'] ?>">
                                    </div>
                                    
                                    <div class="form-group p-left">
                                        <label for="namaStandar">Password</label>
                                        <input class="form-control" type="text" name="password" placeholder="masukan password baru" required>
                                    </div>

                                    <div class="form-group p-left">
                                        <label for="namaStandar">Pilih Hak Akses</label>
                                        <select name="level" class="form-control" required>
                                            <option value="admin" <?php if($res['level'] == 'admin') { echo "selected"; }?>>Administrator</option>
                                            <option value="kaprodi" <?php if($res['level'] == 'kaprodi') { echo "selected"; }?>>Kaprodi</option>
                                            <option value="tim-borang" <?php if($res['level'] == 'tim-borang') { echo "selected"; }?>>Tim Borang</option>
                                        </select>
                                    </div>
                                ...
                                <?php
                                    if(isset($_POST['edit'])){
                                        ...
                                        $level = $_POST['level'];
                                        $queryupdate = mysqli_query($koneksi, "UPDATE user SET username='$username',password='$password',level='$level' WHERE id_user=$id_user");
                                            if($queryupdate){
