...
<head>
    ...
    <style type="text/css">
        .p-left {margin:.5em 0; padding-left: 1em;}
        .p-left-tt {margin-left: 2em;}
        .p-left-btn {margin-left: 3em;}

        .btn-lf {padding-left: 1em;}
        .sub-p {margin-left: 2em; margin-top: .5em; color: #FF0000;}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel">
                                ...
                                <?php
                                    $query1 = mysqli_query($koneksi, "SELECT * FROM isi_standar WHERE id_standar='$id_standar' ORDER BY id_isi_standar ASC") or die (mysqli_error());
                                        if(mysqli_num_rows($query1) == 0){
                                            echo "<div class='form-group p-tt' align='center'>Belum ada, isi data standar!!</div>";
                                        }else{
                                        ...
                                        <?php
                                            $query2 = mysqli_query($koneksi, "SELECT * FROM soal WHERE id_isi_standar='$sub_id'") or die (mysqli_error());
                                                if(mysqli_num_rows($query2) == 0){
                                                    echo "<p class='sub-p'>Belum ada soal!!</p>";
                                                }else{
                                                    while($rw=mysqli_fetch_array($query2)):
                                        ?>
                                        <p class="p-left-tt"><?php echo $rw['soal_standar']; ?></p>
                                        <p class="jwb"><b>Jawaban :</b></p>
                                        <div class="textbox p-left-box">                                        
                                        <?php echo $rw['jawaban']; ?>  
                                        </div>
                                        <?php
                                            endwhile;
                            ...
                            <div class="form-group p-left p-left-btn">
...
<script type="text/javascript">
    ...
    var boxtext = "...";
    var showtext = ">> Show textbox to answer";
    var hidentext = "<< hidden textbox to answer";
    ...
    $('.textbox').each(function() {
        ...
        if(content.length > showChar) { 
            ...
            var html = c + '<span class="morebox">' + boxtext+ '&nbsp;</span><span class="morecontent"><span>' + h + '</span>&nbsp;&nbsp;<a href="" class="morelink">' + showtext + '</a></span>'; 
            $(this).html(html);
        }
