                            ...
                            <div class="panel-body p-left">
                                ...
                                <form action="" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="nama_standar" value="<?php echo $res['nama_standar'] ?>">
                                    </div>
                                    <div class="form-group">
                                ...
                                <?php
                                	if(isset($_POST['edit'])){
                                		...
                                		$queryupdate = mysqli_query($koneksi, "UPDATE standar SET id_user='$id_user', nama_standar='$nama_standar' WHERE id_standar = $id_standar");
                                			if($queryupdate){
