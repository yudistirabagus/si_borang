        ...
        <div class="body-content" style="min-height: 1200px;">
            ...
            <div class="page-head">
                ...
                <div class="state-information">
                    <a href="./tambah-user.php" class="btn btn-primary m-b-10"><i class="fa fa-pencil-square-o"></i> Tambah User</a>
                </div>
            </div>
            <!-- page head end-->
                            ...
                            <table class="table responsive-data-table data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="<?php echo $r['level']; ?>"><?php echo $r['level']; ?></span></td>
                                        <td align="center">
                                            <a href="./edit-user.php?id_user=<?php echo $r['id_user']; ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Edit</a>
                                            <a href="./hapus-user.php?id_user=<?php echo $r['id_user']; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin, ingin menghapus data ini?')"><i class="fa fa-trash-o"></i> Hapus</a>
                                        </td>
                                    </tr>
                                    <?php
                                        endwhile;
