...
$upload_dir = './../test/New/ini/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../New/ini/'; // relative path from filemanager folder to upload folder (with final /)
